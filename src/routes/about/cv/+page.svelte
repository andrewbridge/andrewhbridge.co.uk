...
<style>
    ...
    header p, section p, header p span, section p span, header li, section li, header li span, section li span {
...
<section>
  ...
  <section class="job">
    ...
    <ul>
      ...
      <li>Providing deep integration with the Prismic headless CMS</li>
